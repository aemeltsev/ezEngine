...
EZ_CREATE_SIMPLE_TEST(Reflection, ReflectedTypeReloading)
{
...

  {
    ...
    EZ_TEST_BLOCK(ezTestBlock::Enabled, "AddProperty")
    {
      ...
      descInner.m_Properties.PushBack(
        ezReflectedPropertyDescriptor(ezPropertyCategory::Member, "IP2", "ezVec4", ezBitflags<ezPropertyFlags>(ezPropertyFlags::StandardType), ezArrayPtr<ezPropertyAttribute* const>()));
