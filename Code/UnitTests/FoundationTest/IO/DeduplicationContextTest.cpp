...
namespace
{
  ...
  struct ComplexObject
  {
    ...
    ezResult Serialize(ezStreamWriter& stream) const
    {
      ...
      EZ_SUCCEED_OR_RETURN(ezDeduplicationWriteContext::GetContext()->WriteMap(stream, m_TransformMap, ezDeduplicationWriteContext::WriteMapMode::DedupValue));
    ...
    ezResult Deserialize(ezStreamReader& stream)
    {
      ...
      EZ_SUCCEED_OR_RETURN(
        ezDeduplicationReadContext::GetContext()->ReadMap(stream, m_TransformMap, ezDeduplicationReadContext::ReadMapMode::DedupValue, nullptr, nullptr)); // should not allocate anything
