...
EZ_CREATE_SIMPLE_TEST(Math, Vec3)
{
...

  {
    ...
    EZ_TEST_BLOCK(ezTestBlock::Enabled, "GetLengthAndNormalize")
    {
      ...
      EZ_TEST_FLOAT(vLengthAndNorm.x * vLengthAndNorm.x + vLengthAndNorm.y * vLengthAndNorm.y + vLengthAndNorm.z * vLengthAndNorm.z, 1.0f, ezMath::SmallEpsilon<ezMathTestType>());
  ...
  EZ_TEST_BLOCK(ezTestBlock::Enabled, "Operators")
  {
    ...
    EZ_TEST_BOOL(vMulFloatVec3.IsEqual(ezVec3T((ezMathTestType)-8.0, (ezMathTestType)0.4, (ezMathTestType)-14.0), ezMath::SmallEpsilon<ezMathTestType>()));
