...
EZ_CREATE_SIMPLE_TEST(Math, Intersection)
{
  EZ_TEST_BLOCK(ezTestBlock::Enabled, "RayPolygonIntersection")
  {
    for (ezUInt32 i = 0; i < 100; ++i)
    {
      ...
      ezVec3 Vertices[8] = {m.TransformPosition(ezVec3(-10, -10, 0)), ezVec3(-10, -10, 0), m.TransformPosition(ezVec3(10, -10, 0)), ezVec3(10, -10, 0), m.TransformPosition(ezVec3(10, 10, 0)),
        ezVec3(10, 10, 0), m.TransformPosition(ezVec3(-10, 10, 0)), ezVec3(-10, 10, 0)};
