...
void TestPosition(const ezCoordinateSystemConversion& AtoB, const ezCoordinateSystemConversion& BtoA, const ezVec3& vSourcePos, const ezVec3& vTargetPos)
{
...
void TestRotation(const ezCoordinateSystemConversion& AtoB, const ezCoordinateSystemConversion& BtoA, const ezVec3& vSourceStartDir, const ezVec3& vSourceEndDir, const ezQuat& qSourceRot,
...
EZ_CREATE_SIMPLE_TEST(World, CoordinateSystem)
{
  ...
  EZ_TEST_BLOCK(ezTestBlock::Enabled, "Default Constructed")
  {
    ...
    TestRotation(defaultConstucted, defaultConstucted, ezCoordSysLH.m_vForwardDir, ezCoordSysLH.m_vRightDir, FromAxisAndAngle(ezCoordSysLH.m_vUpDir, rot), ezCoordSysLH.m_vForwardDir,
      ezCoordSysLH.m_vRightDir, FromAxisAndAngle(ezCoordSysLH.m_vUpDir, rot));
    TestRotation(defaultConstucted, defaultConstucted, ezCoordSysLH.m_vUpDir, ezCoordSysLH.m_vForwardDir, FromAxisAndAngle(ezCoordSysLH.m_vRightDir, rot), ezCoordSysLH.m_vUpDir,
      ezCoordSysLH.m_vForwardDir, FromAxisAndAngle(ezCoordSysLH.m_vRightDir, rot));
    TestRotation(defaultConstucted, defaultConstucted, ezCoordSysLH.m_vUpDir, ezCoordSysLH.m_vRightDir, FromAxisAndAngle(ezCoordSysLH.m_vForwardDir, -rot), ezCoordSysLH.m_vUpDir,
      ezCoordSysLH.m_vRightDir, FromAxisAndAngle(ezCoordSysLH.m_vForwardDir, -rot));
  }
}
