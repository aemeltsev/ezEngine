...
namespace ezModelImporter
{
  ...
  ezVec3 ConvertFromFBX(const FbxDouble3& fbxDouble3) { return ezVec3(static_cast<float>(fbxDouble3.mData[0]), static_cast<float>(fbxDouble3.mData[1]), static_cast<float>(fbxDouble3.mData[2])); }
