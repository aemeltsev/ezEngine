  ...
  : QWidget(pParent)
{
  ...
  connect(GradientWidget, &ezQtColorGradientWidget::addColorCp, this, [this](double x, const ezColorGammaUB& color) { Q_EMIT ColorCpAdded(x, color); });
  ...
  connect(GradientWidget, &ezQtColorGradientWidget::addIntensityCp, this, [this](double x, float intensity) { Q_EMIT IntensityCpAdded(x, intensity); });
  connect(GradientWidget, &ezQtColorGradientWidget::moveIntensityCpToPos, this, [this](ezInt32 idx, double x) { Q_EMIT IntensityCpMoved(idx, x); });
