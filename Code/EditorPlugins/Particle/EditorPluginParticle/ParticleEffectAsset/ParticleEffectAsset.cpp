...
void ezParticleEffectAssetDocument::PropertyMetaStateEventHandler(ezPropertyMetaStateEvent& e)
{
  ...
  else if (e.m_pObject->GetTypeAccessor().GetType() == ezGetStaticRTTI<ezParticleTypeQuadFactory>())
  {
    ...
    props["ParticleStretch"].m_Visibility =
      (orientation == ezQuadParticleOrientation::FixedAxis_EmitterDir || orientation == ezQuadParticleOrientation::FixedAxis_ParticleDir) ? ezPropertyUiState::Default : ezPropertyUiState::Invisible;
...
ezStatus ezParticleEffectAssetDocument::InternalTransformAsset(
