...
void ezQtMaterialAssetDocumentWindow::OnOpenShaderClicked(bool)
{
  ...
  ezString sAutoGenShader =
    pManager->GetAbsoluteOutputFileName(GetMaterialDocument()->GetAssetDocumentTypeDescriptor(), GetMaterialDocument()->GetDocumentPath(), ezMaterialAssetDocumentManager::s_szShaderOutputTag);
