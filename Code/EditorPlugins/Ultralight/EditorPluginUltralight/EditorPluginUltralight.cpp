...
void OnLoadPlugin(bool bReloading)
{
  ...
  // Ultralight HTML Asset
  {
    // Menu Bar
    {
      ...
      ezStandardMenus::MapActions("UltralightHTMLAssetMenuBar", ezStandardMenuTypes::File | ezStandardMenuTypes::Edit | ezStandardMenuTypes::Panels | ezStandardMenuTypes::Help);
