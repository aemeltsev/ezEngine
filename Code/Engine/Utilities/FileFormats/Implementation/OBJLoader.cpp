...
void ezOBJLoader::ComputeTangentSpaceVectors()
{
  ...
  for (ezUInt32 f = 0; f < m_Faces.GetCount(); ++f)
  {
    ...
    ezVec3 T, B;
    T = ezVec3((c3c1_B * v2v1.x - c2c1_B * v3v1.x) * fScale1, (c3c1_B * v2v1.y - c2c1_B * v3v1.y) * fScale1, (c3c1_B * v2v1.z - c2c1_B * v3v1.z) * fScale1);

    B = ezVec3((-c3c1_T * v2v1.x + c2c1_T * v3v1.x) * fScale1, (-c3c1_T * v2v1.y + c2c1_T * v3v1.y) * fScale1, (-c3c1_T * v2v1.z + c2c1_T * v3v1.z) * fScale1);
