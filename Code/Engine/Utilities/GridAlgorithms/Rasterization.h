...
namespace ez2DGridUtils
{
  ...
  EZ_UTILITIES_DLL ezRasterizationResult::Enum ComputePointsOnLineConservative(
  ...
  /// neighbors should be visited. If the flood-fill algorithm leaves the valid area, the callback must return ezCallbackResult::Stop to
  ...
  ///
  /// The callback function must return ezCallbackResult::Continue for cells that are not blocking and ezCallbackResult::Stop for cells that
  /// block visibility.
  ///
  ...
  EZ_UTILITIES_DLL void ComputeVisibleArea(ezInt32 iPosX, ezInt32 iPosY, ezUInt16 uiRadius, ezUInt32 uiWidth, ezUInt32 uiHeight, EZ_RASTERIZED_POINT_CALLBACK Callback, void* pPassThrough = nullptr,
  ...
  /// ConeAngle.
  EZ_UTILITIES_DLL void ComputeVisibleAreaInCone(ezInt32 iPosX, ezInt32 iPosY, ezUInt16 uiRadius, const ezVec2& vDirection, ezAngle ConeAngle, ezUInt32 uiWidth, ezUInt32 uiHeight,
