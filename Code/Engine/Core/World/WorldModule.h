...
#define EZ_IMPLEMENT_WORLD_MODULE(moduleType) ezWorldModuleTypeId moduleType::TYPE_ID = ezWorldModuleFactory::GetInstance()->RegisterWorldModule<moduleType, moduleType>();
