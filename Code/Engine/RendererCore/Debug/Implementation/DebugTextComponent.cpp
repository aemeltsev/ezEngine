...
void ezDebugTextComponent::OnMsgExtractRenderData(ezMsgExtractRenderData& msg) const
{
  ...
  if (!m_sText.IsEmpty())
  {
    ...
    ezDebugRenderer::Draw3DText(msg.m_pView->GetHandle(), sb, GetOwner()->GetGlobalPosition(), m_Color, 16, ezDebugRenderer::HorizontalAlignment::Center, ezDebugRenderer::VerticalAlignment::Bottom);
  }
}
