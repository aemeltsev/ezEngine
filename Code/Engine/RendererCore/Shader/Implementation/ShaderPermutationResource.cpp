...
ezResourceLoadDesc ezShaderPermutationResource::UpdateContent(ezStreamReader* Stream)
{
  ...
  for (ezUInt32 stage = ezGALShaderStage::VertexShader; stage < ezGALShaderStage::ENUM_COUNT; ++stage)
  {
    ...
    EZ_ASSERT_DEV(
      pStageBin->m_Stage == stage, "Invalid shader stage! Expected stage '{0}', but loaded data is for stage '{1}'", ezGALShaderStage::Names[stage], ezGALShaderStage::Names[pStageBin->m_Stage]);
