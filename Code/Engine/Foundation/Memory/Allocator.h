...
class ezAllocator : public ezInternal::ezAllocatorMixinReallocate<AllocationPolicy, TrackingFlags, ezHasReallocate<AllocationPolicy, void* (AllocationPolicy::*)(void*, size_t, size_t, size_t)>::value>
{
public:
  ezAllocator(const char* szName, ezAllocatorBase* pParent = nullptr)
    : ezInternal::ezAllocatorMixinReallocate<AllocationPolicy, TrackingFlags, ezHasReallocate<AllocationPolicy, void* (AllocationPolicy::*)(void*, size_t, size_t, size_t)>::value>(szName, pParent)
  {
  }
};
