...
ezStringView BuildString(char* tmp, ezUInt32 uiLength, const ezDateTime& arg)
{
  ezStringUtils::snprintf(
    tmp, uiLength, "%04u-%02u-%02u_%02u-%02u-%02u-%03u", arg.GetYear(), arg.GetMonth(), arg.GetDay(), arg.GetHour(), arg.GetMinute(), arg.GetSecond(), arg.GetMicroseconds() / 1000);
...
ezStringView BuildString(char* tmp, ezUInt32 uiLength, const ezArgDateTime& arg)
{
  ...
  if ((arg.m_uiFormattingFlags & ezArgDateTime::ShowDate) == ezArgDateTime::ShowDate)
  {
    ...
    {
      offset += ezStringUtils::snprintf(tmp + offset, uiLength - offset, "%04u %s %02u", dateTime.GetYear(), ::GetMonthShortName(dateTime), dateTime.GetDay());
    }
    else
    {
      offset += ezStringUtils::snprintf(tmp + offset, uiLength - offset, "%04u-%02u-%02u", dateTime.GetYear(), dateTime.GetMonth(), dateTime.GetDay());
    }
  }
