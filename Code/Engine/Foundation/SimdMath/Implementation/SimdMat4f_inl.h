...
EZ_ALWAYS_INLINE ezSimdMat4f::ezSimdMat4f(
  float c1r1, float c2r1, float c3r1, float c4r1, float c1r2, float c2r2, float c3r2, float c4r2, float c1r3, float c2r3, float c3r3, float c4r3, float c1r4, float c2r4, float c3r4, float c4r4)
{
...
{
  return (m_col0.IsEqual(ezSimdVec4f(1, 0, 0, 0), fEpsilon) && m_col1.IsEqual(ezSimdVec4f(0, 1, 0, 0), fEpsilon) && m_col2.IsEqual(ezSimdVec4f(0, 0, 1, 0), fEpsilon) &&
          m_col3.IsEqual(ezSimdVec4f(0, 0, 0, 1), fEpsilon))
    .AllSet<4>();
}
