...
static void OutputIntSign(char* szOutputBuffer, unsigned int uiBufferSize, unsigned int& uiWritePos, long long int value, unsigned int Flags, int iBase, bool bUpperCase, int iPrecision)
{
  if (value < 0)
    OutputChar(szOutputBuffer, uiBufferSize, uiWritePos, '-');
  else if (Flags & sprintfFlags::ForceSign)
  {
    if (value > 0)
      OutputChar(szOutputBuffer, uiBufferSize, uiWritePos, '+');
    else
  ...
  else if (Flags & sprintfFlags::BlankSign)
    OutputChar(szOutputBuffer, uiBufferSize, uiWritePos, ' ');
  else if (Flags & sprintfFlags::ForceZeroSign)
    OutputChar(szOutputBuffer, uiBufferSize, uiWritePos, '+');
...
static void OutputIntSignAndPadding(
  char* szOutputBuffer, unsigned int uiBufferSize, unsigned int& uiWritePos, long long int value, unsigned int Flags, int iPadding, int iBase, bool bUpperCase, int iPrecision)
{
  if (Flags & sprintfFlags::PadZeros)
  {
...
static void OutputUInt(
  char* szOutputBuffer, unsigned int uiBufferSize, unsigned int& uiWritePos, unsigned long long int value, int iWidth, int iPrecision, unsigned int Flags, int iBase, bool bUpperCase)
{
...
static void OutputFloat(
  char* szOutputBuffer, unsigned int uiBufferSize, unsigned int& uiWritePos, double value, int iWidth, int iPrecision, unsigned int Flags, bool bUpperCase, bool bScientific, bool bRemoveZeroes)
{
  char szBuffer[128];
...
void ezStringUtils::OutputFormattedFloat(
  char* szOutputBuffer, ezUInt32 uiBufferSize, ezUInt32& uiWritePos, double value, ezUInt8 uiWidth, bool bPadZeros, ezInt8 iPrecision, bool bScientific, bool bRemoveTrailingZeroes)
{
  OutputFloat(szOutputBuffer, uiBufferSize, uiWritePos, value, uiWidth, ezMath::Max<int>(-1, iPrecision), bPadZeros ? sprintfFlags::PadZeros : 0, false, bScientific, bRemoveTrailingZeroes);
}
