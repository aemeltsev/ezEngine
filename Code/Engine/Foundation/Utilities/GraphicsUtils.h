...
namespace ezGraphicsUtils
{
  ...
  EZ_FOUNDATION_DLL ezResult ConvertWorldPosToScreenPos(const ezMat4& ModelViewProjection, const ezUInt32 uiViewportX, const ezUInt32 uiViewportY, const ezUInt32 uiViewportWidth,
  ...
  /// properly.
  EZ_FOUNDATION_DLL ezResult ConvertScreenPosToWorldPos(const ezMat4& InverseModelViewProjection, const ezUInt32 uiViewportX, const ezUInt32 uiViewportY, const ezUInt32 uiViewportWidth,
    const ezUInt32 uiViewportHeight, const ezVec3& vScreenPos, ezVec3& out_vPoint, ezVec3* out_vDirection = nullptr,
    ezClipSpaceDepthRange::Enum DepthRange = ezClipSpaceDepthRange::Default); // [tested]

  /// \brief A double-precision version of ConvertScreenPosToWorldPos()
  EZ_FOUNDATION_DLL ezResult ConvertScreenPosToWorldPos(const ezMat4d& InverseModelViewProjection, const ezUInt32 uiViewportX, const ezUInt32 uiViewportY, const ezUInt32 uiViewportWidth,
    const ezUInt32 uiViewportHeight, const ezVec3& vScreenPos, ezVec3& out_vPoint, ezVec3* out_vDirection = nullptr,
    ezClipSpaceDepthRange::Enum DepthRange = ezClipSpaceDepthRange::Default); // [tested]
  ...
  EZ_FOUNDATION_DLL void ConvertProjectionMatrixDepthRange(ezMat4& inout_Matrix, ezClipSpaceDepthRange::Enum SrcDepthRange, ezClipSpaceDepthRange::Enum DstDepthRange); // [tested]
  ...
  EZ_FOUNDATION_DLL ezPlane ComputeInterpolatedFrustumPlane(
    FrustumPlaneInterpolation dir, float fLerpFactor, const ezMat4& ProjectionMatrix, ezClipSpaceDepthRange::Enum DepthRange = ezClipSpaceDepthRange::Default); // [tested]

  /// \brief Creates a perspective projection matrix with Left = -fViewWidth/2, Right = +fViewWidth/2, Bottom = -fViewHeight/2, Top =
  /// +fViewHeight/2.
  EZ_FOUNDATION_DLL ezMat4 CreatePerspectiveProjectionMatrix(float fViewWidth, float fViewHeight, float fNearZ, float fFarZ, ezClipSpaceDepthRange::Enum DepthRange = ezClipSpaceDepthRange::Default,
  ...
  EZ_FOUNDATION_DLL ezMat4 CreatePerspectiveProjectionMatrixFromFovX(ezAngle fieldOfViewX, float fAspectRatioWidthDivHeight, float fNearZ, float fFarZ,
    ezClipSpaceDepthRange::Enum DepthRange = ezClipSpaceDepthRange::Default, ezClipSpaceYMode::Enum yRange = ezClipSpaceYMode::Regular,
    ezHandedness::Enum handedness = ezHandedness::Default); // [tested]

  /// \brief Creates a perspective projection matrix.
  /// \param fFieldOfViewY    Vertical field of view.
  EZ_FOUNDATION_DLL ezMat4 CreatePerspectiveProjectionMatrixFromFovY(ezAngle fieldOfViewY, float fAspectRatioWidthDivHeight, float fNearZ, float fFarZ,
    ezClipSpaceDepthRange::Enum DepthRange = ezClipSpaceDepthRange::Default, ezClipSpaceYMode::Enum yRange = ezClipSpaceYMode::Regular,
    ezHandedness::Enum handedness = ezHandedness::Default); // [tested]

  /// \brief Creates an orthographic projection matrix with Left = -fViewWidth/2, Right = +fViewWidth/2, Bottom = -fViewHeight/2, Top =
  /// +fViewHeight/2.
  EZ_FOUNDATION_DLL ezMat4 CreateOrthographicProjectionMatrix(float fViewWidth, float fViewHeight, float fNearZ, float fFarZ, ezClipSpaceDepthRange::Enum depthRange = ezClipSpaceDepthRange::Default,
    ezClipSpaceYMode::Enum yRange = ezClipSpaceYMode::Regular,
    ezHandedness::Enum handedness = ezHandedness::Default); // [tested]
  ...
  EZ_FOUNDATION_DLL ezMat4 CreateViewMatrix(
    const ezVec3& vPosition, const ezVec3& vForwardDir, const ezVec3& vRightDir, const ezVec3& vUpDir, ezHandedness::Enum handedness = ezHandedness::Default); // [tested]

  /// \brief Similar to CreateViewMatrix() but creates the inverse matrix.
  EZ_FOUNDATION_DLL ezMat4 CreateInverseViewMatrix(
    const ezVec3& vPosition, const ezVec3& vForwardDir, const ezVec3& vRightDir, const ezVec3& vUpDir, ezHandedness::Enum handedness = ezHandedness::Default); // [tested]
  ...
  EZ_FOUNDATION_DLL void DecomposeViewMatrix(
    ezVec3& out_vPosition, ezVec3& out_vForwardDir, ezVec3& out_vRightDir, ezVec3& out_vUpDir, const ezMat4& viewMatrix, ezHandedness::Enum handedness = ezHandedness::Default); // [tested]
