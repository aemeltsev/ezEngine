...
void ezDrawBoxGizmo::UpdateStatusBarText(ezQtEngineDocumentWindow* pWindow)
{
  switch (m_ManipulateMode)
  {
    ...
    case ManipulateMode::DrawBase:
    {
      ...
      pWindow->SetPermanentStatusBarMsg(ezFmt("Greyboxing: [Width: {}, Depth: {}, Height: {}] Release the mouse to finish the base. ESC to cancel.", ezArgF(diff.y, 2, false, 2),
        ezArgF(diff.x, 2, false, 2), ezArgF(m_fBoxHeight, 2, false, 2)));
      break;
    }
    ...
    case ManipulateMode::DrawHeight:
    {
      ...
      pWindow->SetPermanentStatusBarMsg(ezFmt("Greyboxing: [Width: {}, Depth: {}, Height: {}] Draw up/down to specify the box height. Click to finish, ESC to cancel.", ezArgF(diff.y, 2, false, 2),
        ezArgF(diff.x, 2, false, 2), ezArgF(m_fBoxHeight, 2, false, 2)));
      break;
    }
  }
