...
ezAssetWatcher::ezAssetWatcher(const ezApplicationFileSystemConfig& fileSystemConfig)
{
  ...
  for (auto& dd : m_FileSystemConfig.m_DataDirs)
  {
    ...
    ezResult res = pWatcher->OpenDirectory(sTemp,
      ezDirectoryWatcher::Watch::Reads | ezDirectoryWatcher::Watch::Writes | ezDirectoryWatcher::Watch::Creates | ezDirectoryWatcher::Watch::Renames | ezDirectoryWatcher::Watch::Subdirectories);
