...
void ezQtAssetImportDlg::BrowseButtonClicked(bool)
{
  ...
  else
  {
    ...
    QString result =
      QFileDialog::getSaveFileName(this, "Target Document", ezToolsProject::GetSingleton()->GetProjectDirectory().GetData(), filter.GetData(), nullptr, QFileDialog::Option::DontResolveSymlinks);
