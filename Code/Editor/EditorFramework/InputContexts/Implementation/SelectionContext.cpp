...
static const bool IsInSelection(const ezDeque<const ezDocumentObject*>& selection, const ezDocumentObject* pObject, const ezDocumentObject*& out_ParentInSelection,
  const ezDocumentObject*& out_ParentChild, const ezDocumentObject* pRootObject)
{
