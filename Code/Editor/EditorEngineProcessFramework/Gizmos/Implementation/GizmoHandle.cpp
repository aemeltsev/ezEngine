...
void ezEngineGizmoHandle::Configure(
  ezGizmo* pParentGizmo, ezEngineGizmoHandleType type, const ezColor& col, bool bConstantSize, bool bAlwaysOnTop, bool bVisualizer, bool bShowInOrtho, bool bIsPickable)
{
